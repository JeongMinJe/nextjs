    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mt-8 grid md:grid-cols-2 gap-6">
          <div
            className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 animate-slideInFromRight"
        ...
        {/* Inspiration Section */}
        <div
          className="mt-8 bg-white rounded-lg shadow-sm border border-gray-200 p-6 animate-fadeIn"
